    public class Main {
     ...
     Shop h1 = new Shop("Shop A", new Tradables[] {p1,s1}); //Shop name, products and services 
     Shop h2 = new Shop("Shop B", new Tradables[] {p1,p2,p3});
     Shop h3 = new Shop("Shop C", new Tradables[] {s1,s2,s3});
